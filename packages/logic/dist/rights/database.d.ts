...
export declare const RIGHTS_ITEMS: readonly RightItem[];
export declare function getRightsAuthority(id: RightsAuthority["id"]): RightsAuthority;
export declare function getRightsTopic(id: RightsTopic["id"]): RightsTopic;
