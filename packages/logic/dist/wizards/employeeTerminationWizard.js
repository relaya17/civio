export const employeeTerminationWizard = {
    id: "employee-termination.v1",
    title: "זכויות עובדים: פיטורים / שימוע (שאלון קצר)",
    description: "שאלון קצר עם בחירה בכפתורים כדי להבין אילו מסלולים אפשריים עבורך, ומה כדאי לבדוק בהמשך.",
    disclaimer: {
        short: "מידע כללי בלבד (לא ייעוץ משפטי)",
        full: "Civio מספקת מידע כללי בלבד ואינה מהווה ייעוץ משפטי, חוות דעת או תחליף לעורך דין. ייתכן שהדין תלוי בפרטים נוספים.",
    },
    steps: [
        {
        ...
        },
        {
            ...
            whyAsking: "כדי להבין האם ייתכן שמגיע לך תשלום/השלמה, או שיש צורך לבדוק את תקופת ההודעה.",
            options: [
                { value: "yes", label: "כן" },
                { value: "no", label: "לא" },
                { value: "not-sure", label: "לא בטוח / לא יודע" },
