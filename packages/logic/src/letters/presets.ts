...
export interface LetterPreset {
  ...
  readonly situation?: LetterSituation; // Situation this preset is for
}
...
const PRESETS: readonly LetterPreset[] = [
  ...
  // New smart templates based on user requirements
  {
    ...
    facts:
      "אני פונה אליכם בנוגע ל___, אשר התרחש בתאריך ___.\n" +
      "זהו המגע הראשון שלי בנושא זה.",
    request:
      "אבקש את התייחסותכם והנחיות ברורות כיצד לפעול בהמשך.\n" +
  ...
  },
  {
    ...
    request:
      "בהסתמך על חובת רשות מקומית לפעול בשקיפות, סבירות ומתן מענה לאזרחים, היעדר ההתייחסות גורם לי קושי ממשי בהתנהלות ופוגע ביכולתי למצות את זכויותיי.\n" +
  ...
  },
  {
    ...
    situation: "warning",
    facts:
      "פניתי אליכם מספר פעמים בנושא ___ (תאריכים: ___, ___, ___).\n" +
      "למרות פניות חוזרות, טרם התקבל מענה או טיפול בנושא.\n" +
      "הדבר גורם לי נזק ממשי ופוגע בזכויותיי.",
    request:
      "אבקש לקבל מענה וטיפול בהקדם האפשרי, לפני שאאלץ לפנות לגורמים נוספים.\n" +
  ...
  },
  {
    ...
    situation: "first-contact",
    facts:
      "אני פונה אליכם בבקשה לבירור/הגשת תביעה בנושא ___.\n" +
      "זהו המגע הראשון שלי בנושא זה.",
    request:
      "אבקש הנחיות ברורות כיצד להגיש את הבקשה/התביעה ומה המסמכים הנדרשים.\n" +
  ...
  },
  {
    ...
    situation: "no-response",
    facts:
      "בתאריך ___ הגשתי תביעה / פנייה בנושא ___.\n" +
      "בתאריך ___ פניתי שוב לקבלת עדכון.\n" +
      "חרף זאת, לא קיבלתי מענה מסודר או החלטה מנומקת.",
    request:
      "בהסתמך על זכות המבוטח לקבל החלטה בתוך זמן סביר ובהתאם לכללי המינהל התקין, היעדר המענה מקשה עליי ופוגע בזכויותיי הסוציאליות.\n" +
  ...
  },
  {
    ...
    facts:
      "אני פונה אליכם בנוגע ל___, אשר פניתי בעניינו בתאריך ___.\n" +
      "למרות פניות נוספות בתאריך ___, טרם קיבלתי מענה מספק.",
    request:
      "בהסתמך על זכות המטופל לקבל מידע ומענה בזמן סביר, היעדר ההתייחסות פוגע ביכולתי לקבל טיפול מתאים.\n" +
  ...
  },
  {
    ...
    facts:
      "בתאריך ___ פניתי אליכם בנושא ___.\n" +
      "חרף פניות חוזרות, טרם נמסר לי מענה ענייני.",
    request:
      "בהתאם לעקרונות השירות הציבורי וחובת מתן מענה לפניות אזרחים, אבקש לקבל התייחסות מסודרת ומנומקת.\n" +
