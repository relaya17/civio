import type { GeneratedLetter, LetterComposerInput } from "@repo/types";
...
import {
  ...
  getRequestByUrgency,
  IMPACT_SENTENCES,
  LEGAL_SOFT_SENTENCES,
  NO_RESPONSE_SENTENCES,
  random,
} from "./smartTemplates.js";

function line(v: string | undefined) {
...
export function generateLetter(input: LetterComposerInput): GeneratedLetter {
  ...
  const bodyParts: Array<string | undefined> = [opener, ""];
