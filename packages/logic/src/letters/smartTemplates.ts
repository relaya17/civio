...
export function getBodyTemplate(authorityId: LetterAuthorityId, topic: string, firstDate: string): string {
...
// בחירת פתיח לפי טון
export function getOpenerByTone(tone: LetterTone = "formal"): string {
  if (tone === "soft") {
...
// בחירת סגירה לפי טון
export function getClosingByTone(tone: LetterTone = "formal"): string {
  if (tone === "soft") {
    return "בתודה מראש,";
  }
  if (tone === "formal-legal") {
...
export function getRequestByUrgency(
  urgency: "normal" | "high" | undefined,
